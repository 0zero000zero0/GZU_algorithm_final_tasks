...
class Ui_Base(object):
    def setupUi(self, Base):
        ...
        self.chooses.addItem("")
        self.chooses.addItem("")
        self.verticalLayout_10.addWidget(self.chooses)
        ...
        self.toend = QtWidgets.QWidget(parent=self.options)
        self.toend.setObjectName("toend")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.toend)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.start_3 = QtWidgets.QPushButton(parent=self.toend)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.start_3.setFont(font)
        self.start_3.setObjectName("start_3")
        self.verticalLayout_9.addWidget(self.start_3)
        self.verticalLayout_10.addWidget(self.toend)
    ...
    def retranslateUi(self, Base):
        ...
        self.chooses.setItemText(3, _translate("Base", "凸包(分治法)"))
...
"-3 2"))
        ...
        self.start_3.setText(_translate("Base", "结果"))
